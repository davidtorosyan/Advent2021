 ...
 */
class Day14Part1 : PuzzleBase<Day14Part1.Template, Day14Part1.Polymer>() {
    ...
    data class Polymer(val start: Base, val end: Base, val pairs: Map<BasePair, Int>)
    ...
    private fun Polymer.count() : Map<Base, Int> {
        return pairs.map {
            listOf(
